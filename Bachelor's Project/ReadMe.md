...
This project investigated how the temperature of Jupiter's upper atmosphere varies from the pole to the equator.  
From previous studies, it was discovered that the equatorial regions of Jupiter's upper atmosphere are unexpectedly hot.

This project uses fresh data, collected in sequence over a month-long period, to test how the temperature of the polar and equatorial regions varies over a short period of time.

To calculate the temperature of Jupiter's upper atmosphere, H<sub>3</sub><sup>+</sup> emission lines are identified.  
H<sub>3</sub><sup>+</sup> is produced through a chemical reaction between H<sub>2</sub> and incoming electrons.  
A greater quantity of H<sub>3</sub><sup>+</sup> indicates a hotter atmosphere.

    </td>
    <td width="40%" valign="top">

<img src="Images/Jupiter_Scan.png" alt="Telescope Data Retrieval" width="100%">
