...
For access to other data from NASA's IRTF telescope visit, https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/KVQWNJ 
...
An example image showing IRTF collecting this dataset can be seen below: 
<p align="center">
  <img src="Images/Jupiter_Scan.png" alt="Telescope Data Retrieval" width="300">
</p>

To calculate the temperature of jupiter's upper atmosphere, you first need to locate H<sub>3</sub><sup>+</sup> emission lines. H<sub>3</sub><sup>+</sup> is produced when through a chemical reaction between H<sub>2</sub> and incoming electrons. The greater the quantity of H<sub>3</sub><sup>+</sup> present, the hotter the atmosphere is. 
